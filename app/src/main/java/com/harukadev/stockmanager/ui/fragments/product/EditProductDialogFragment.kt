...
class EditProductDialogFragment : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        productNameEditText = view.findViewById(R.id.textInputLayout_edit_product_name)
        barcodeEditText = view.findViewById(R.id.textInputLayout_edit_barcode)
        amountEditText = view.findViewById(R.id.textInputLayout_edit_amount)
        ...
        amountEditText.setText(product.quantity.toString())
        ...
        confirmButton.setOnClickListener {
            ...
            } else if (amount == null || amount < 1 || amount > 999) {
